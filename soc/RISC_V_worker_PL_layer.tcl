...
#
# RISC_V_worker_PL_layer.tcl: Tcl script for re-creating project 'RISC_V_worker_PL_layer'
#
# Generated by Vivado on Wed Dec 10 18:18:26 CET 2025
...
#
# 1. This project restoration tcl script (RISC_V_worker_PL_layer.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/home/szymon/Documents/ISAE/rp/RISCV-Research-Project/soc/RISC_V_worker_PL_layer/RISC_V_worker_PL_layer.srcs/utils_1/imports/synth_1/RISC_V_worker_PL_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/RISC_V_worker_PL_layer/RISC_V_worker_PL_layer.srcs/utils_1/imports/synth_1/RISC_V_worker_PL_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/ip_repos"]"]"\
  ]
  foreach ipath $paths {
...
set _xil_proj_name_ "RISC_V_worker_PL_layer"
...
set script_file "RISC_V_worker_PL_layer.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/RISC_V_worker_PL_layer"]"
...
set_property -name "top" -value "RISC_V_worker_PL_wrapper" -objects $obj
...
set file "synth_1/RISC_V_worker_PL_wrapper.dcp"
...
# Proc to create BD RISC_V_worker_PL
proc cr_bd_RISC_V_worker_PL { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name RISC_V_worker_PL
...
\
  ...
  # Create instance: risc_v_32i_cm_0, and set properties
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.767327",
   "Default View_TopLeft":"167,-128",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 9 -x 2490 -y 360 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 9 -x 2490 -y 380 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -x 230 -y 410 -defaultsOSRD
preplace inst axi_bram_ctrl_0 -pg 1 -lvl 7 -x 2070 -y 210 -defaultsOSRD
preplace inst blk_mem_gen_0 -pg 1 -lvl 8 -x 2340 -y 210 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -x 230 -y 200 -defaultsOSRD
preplace inst risc_v_32i_cm_0 -pg 1 -lvl 4 -x 1200 -y 100 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 2 -x 610 -y 210 -defaultsOSRD
preplace inst axi_protocol_convert_0 -pg 1 -lvl 3 -x 930 -y 80 -defaultsOSRD
preplace inst axi_interconnect_1 -pg 1 -lvl 6 -x 1770 -y 190 -defaultsOSRD
preplace inst axi_protocol_convert_1 -pg 1 -lvl 5 -x 1450 -y 120 -defaultsOSRD
preplace netloc processing_system7_0_FCLK_CLK0 1 0 7 30 300 450 70 760 160 1080 10 1300 30 1610 30 1930J
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 20 100 430
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 6 440 60 770 170 1100 180 1300 200 1620 40 1920J
preplace netloc axi_bram_ctrl_0_BRAM_PORTA 1 7 1 NJ 210
preplace netloc processing_system7_0_DDR 1 1 8 NJ 360 NJ 360 NJ 360 NJ 360 NJ 360 NJ 360 NJ 360 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 8 NJ 380 NJ 380 NJ 380 NJ 380 NJ 380 NJ 380 NJ 380 NJ
preplace netloc S00_AXI_1 1 1 1 460 130n
preplace netloc axi_interconnect_0_M00_AXI 1 2 1 780 60n
preplace netloc axi_protocol_convert_0_M_AXI 1 3 1 N 80
preplace netloc axi_interconnect_0_M01_AXI 1 2 4 NJ 220 1090J 20 NJ 20 1600
preplace netloc axi_interconnect_1_M00_AXI 1 6 1 N 190
preplace netloc risc_v_32i_cm_0_M_AXI 1 4 1 N 100
preplace netloc axi_protocol_convert_1_M_AXI 1 5 1 N 120
levelinfo -pg 1 0 230 610 930 1200 1450 1770 2070 2340 2490
pagesize -pg 1 -db -bbox -sgen 0 0 2610 520
"
}
...
# End of cr_bd_RISC_V_worker_PL()

cr_bd_RISC_V_worker_PL ""
set_property REGISTERED_WITH_MANAGER "1" [get_files RISC_V_worker_PL.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files RISC_V_worker_PL.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list RISC_V_worker_PL.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/RISC_V_worker_PL_layer/RISC_V_worker_PL_layer.gen/sources_1/bd/RISC_V_worker_PL/hdl/RISC_V_worker_PL_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list RISC_V_worker_PL.bd]] -top]
...
set obj [get_runs synth_1]
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/RISC_V_worker_PL_wrapper.dcp" -objects $obj
